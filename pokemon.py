...
with st.container():
    ...
    with col1: 
        with st.container(border=True):
            ...
            with cont_col_2:
                st.write(f'<span style="font-size: 10px; line-height: 0.8; padding-bottom: 10px;">Name: {name} <br> Height: {height}  <br> Weight: {weight} <br> Moves: {moves} </span>', unsafe_allow_html=True, use_column_width=True )
    ...
    # with st.markdown("<div style='border: 2px solid #e6e6e6; padding: 10px;'>", unsafe_allow_html=True):
            ...
            with cont_col_2: 
                st.write(f'<span style="font-size: 10px; line-height: 0.8; padding-bottom: 10px;">Name: {name2} <br> Height: {height2}  <br> Weight: {weight2} <br> Moves: {moves2} </span>', unsafe_allow_html=True, use_column_width=True)
